...
export const employees = pgTable("employees", {
  ...
  salaryDeductions: numeric("salary_deductions", { precision: 10, scale: 2 }),
  fines: numeric("fines", { precision: 10, scale: 2 }),
  totalLoans: numeric("total_loans", { precision: 10, scale: 2 }),
  bonuses: numeric("bonuses", { precision: 10, scale: 2 }),
  company: text("company"),
  vacationReturnDate: date("vacation_return_date"),
  residencyOnCompany: boolean("residency_on_company"),
  professionCategory: text("profession_category"),
  recSalaryVacation: numeric("rec_salary_vacation", { precision: 10, scale: 2 }),
